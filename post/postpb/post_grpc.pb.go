...
func (UnimplementedPostServiceServer) CreatePost(context.Context, *Post) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreatePost not implemented")
}
func (UnimplementedPostServiceServer) GetAllPosts(context.Context, *Empty) (*Posts, error) {
